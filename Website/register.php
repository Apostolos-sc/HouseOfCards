<?php
    ...
    //Need to write some php logic to handle registration. 
    //Step 1. Check and see if all fields are filled, step 2, check and see if valid inputs were given
    //Step 3. Need to check the DB and see if the username already exists.
    //Step 4. Insert the information in the DB
/*
                    ...
                    <div id="center-content">
                        ...
                        if($process == true) {
                            if($success == true) {
                                ...
                                //print the information of the registration in a nice format.
                                //header("Location: index.php");
                            } else {
                                echo "You cannot register with the given credentials. Please try again.";
                            }
                        } else {
                            //Add more fields to get all the information!!
                            echo "
